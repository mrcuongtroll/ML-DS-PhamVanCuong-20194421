...
def load_dataset():
    train_data_reader = DataReader(
        data_path = '../datasets/20news-bydate/20newsgroups_data_tf_idf_train.txt',
        batch_size = 50,
        vocab_size = vocab_size
    )
    test_data_reader = DataReader(
        data_path = '../datasets/20news-bydate/20newsgroups_data_tf_idf_test.txt',
        batch_size = 50,
        vocab_size = vocab_size
    )
...
if __name__ == '__main__':
    ...
    with tf.compat.v1.Session() as sess:
        ...
        step, MAX_STEP = 0, 10000        #1000**2 will set my laptop on fire
    ...
    with tf.compat.v1.Session() as sess:
        ...
        trainable_variables = tf.compat.v1.trainable_variables()
        for variable in trainable_variables:
            saved_value = resore_parameters(variable.name, epoch)
