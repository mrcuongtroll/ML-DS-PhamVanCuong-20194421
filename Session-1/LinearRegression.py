...
if __name__ == '__main__':
    X, Y = get_data('..\datasets\death_rates_data.txt')
    ...
    # W_learned = ridge_regression.fit_gradient_descent(X_train=X_train, Y_train=Y_train, LAMBDA=best_LAMBDA, learning_rate=0.01, max_num_epoch=1000)
