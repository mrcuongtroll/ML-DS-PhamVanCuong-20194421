...
class RNN:
    ...
    def build_graph(self):
        ...
        weigths = tf.compat.v1.get_variable(
...
if __name__ == '__main__':
    ...
    vocab_path = '../datasets/w2v/vocab_raw.txt'
    train_data_path = '../datasets/w2v/20news_train_encoded.txt'
    test_data_path = '../datasets/w2v/20news_test_encoded.txt'
    ...
    with tf.compat.v1.Session() as sess:
        ...
        step = 0
        MAX_STEP = 1000  # even 10000 could set my laptop on fire    # 1000**2 will burn my laptop to ash

        sess.run(tf.compat.v1.global_variables_initializer())
        while step < MAX_STEP:
            next_train_batch = train_data_reader.next_batch()
            train_data, train_labels, train_sequence_lengths, train_final_tokens = next_train_batch
            plabels_eval, loss_eval, _ = sess.run(
                [predicted_labels, loss, train_op],
                feed_dict = {
                    rnn._data: train_data,
                    rnn._labels: train_labels,
                    rnn._sentence_lengths: train_sequence_lengths,
            ...
            if train_data_reader._batch_id == 0:
                ...
                while True:
                    ...
                    test_data, test_labels, test_sequence_lengths, test_final_tokens = next_test_batch
                    ...
                    test_plabels_eval = sess.run(
                        ...
                        feed_dict = {
                            ...
                            rnn._sentence_lengths: test_sequence_lengths,
                    ...
                    # if test_data_reader.current_part == 0:
